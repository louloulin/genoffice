...
export const ar = {
  ...
  aiTranslatePrompt:
    'ترجمة محتوى هذه الخلايا إلى لغة المستخدم، مع الحفاظ على جميع التنسيقات (تنسيقات الأرقام، المحاذاة، الخط، الحجم، اللون، الحدود، الخلايا المدمجة، التعليقات). عدّل قيمة الخلية فقط، ولا تلمس الصيغ أو مراجع أوراق العمل الأخرى، ولا تضف أو تحذف صفوفاً أو أعمدة.',
  ...
  aiCmdGroupSkills: 'مهارات',
  aiCmdGroupActions: 'إجراءات سريعة',
  aiCmdGroupTemplates: 'قوالب',
  aiSkillWorkbook: 'المصنف',
  aiSkillWorkbookDesc: 'قراءة/كتابة الخلايا والصيغ والمخططات',
  aiSkillFiles: 'المرفقات',
  aiSkillFilesDesc: 'قراءة الملفات المرفقة',
  aiSkillSearch: 'بحث ويب',
  aiSkillSearchDesc: 'بيانات/حقائق حديثة',
  aiSkillImage: 'صورة (بحث/توليد)',
  aiSkillImageDesc: 'إيجاد أو توليد صورة',
  aiSkillMerge: 'دمج المصنفات',
  aiSkillMergeDesc: 'دمج عدة مصنفات',
  aiCmdTplBrief: 'ملخص المهمة',
  aiCmdTplBriefDesc: 'تحديد الهدف والنطاق ومعايير القبول',
  aiCmdTplBriefInsert: 'الهدف:\nالنطاق:\nالبيانات/المراجع:\nالقيود:\nمعايير القبول:\nالصيغة:',
  aiModeAsk: 'اسأل',
  aiModeCraft: 'نفّذ',
  aiModePlan: 'خطّط',
  aiModeAskHint: 'قراءة فقط',
  aiModeCraftHint: 'عدّل المصنف',
  aiModePlanHint: 'اقترح خطة',
