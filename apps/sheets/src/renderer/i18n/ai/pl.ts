...
export const pl = {
  ...
  aiCmdGroupActions: 'Szybkie akcje',
  aiCmdGroupTemplates: 'Szablony',
  aiSkillWorkbook: 'Skoroszyt',
  aiSkillWorkbookDesc: 'Odczyt/zapis komórek, formuły, wykresy',
  aiSkillFiles: 'Załączniki',
  aiSkillFilesDesc: 'Czytaj załączone pliki',
  aiSkillSearch: 'Wyszukiwanie w sieci',
  aiSkillSearchDesc: 'Aktualne dane/fakty',
  aiSkillImage: 'Obraz (szukaj/generuj)',
  aiSkillImageDesc: 'Znajdź lub wygeneruj obraz',
  aiSkillMerge: 'Scal skoroszyty',
  aiSkillMergeDesc: 'Połącz wiele skoroszytów',
  aiCmdTplBrief: 'Brief zadania',
  aiCmdTplBriefDesc: 'Cel, zakres, kryteria akceptacji',
  aiCmdTplBriefInsert: 'Cel:\nZakres:\nDane/Referencje:\nOgraniczenia:\nAkceptacja:\nFormat:',
  aiModeAsk: 'Pytaj',
  aiModeCraft: 'Twórz',
  aiModePlan: 'Planuj',
  aiModeAskHint: 'Tylko odczyt',
  aiModeCraftHint: 'Edytuj skoroszyt',
  aiModePlanHint: 'Najpierw plan',
