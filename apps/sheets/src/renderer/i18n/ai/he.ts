...
export const he = {
  ...
  aiAnalyzePrompt: 'נתח את הנתונים בגיליון זה וסכם ממצאים עיקריים, מגמות וחריגות',
    aiTranslateBtn: 'תרגם',
  aiTranslatePrompt:
    'תרגם את תוכן התאים האלה לשפת היעד (לפי שפת ממשק המשתמש). שמור על כל העיצוב: תבניות מספרים, יישור, גופן, גודל, צבע, גבולות, תאים ממוזגים, הערות. שנה רק את ערך התא; אל תיגע בנוסחאות, בהפניות לגיליונות אחרים, ואל תוסיף או תסיר שורות או עמודות.',
  ...
  aiCmdGroupActions: 'פעולות מהירות',
  aiCmdGroupTemplates: 'תבניות',
  aiSkillWorkbook: 'חוברת עבודה',
  aiSkillWorkbookDesc: 'קריאה/כתיבה של תאים, נוסחאות, תרשימים',
  aiSkillFiles: 'קבצים מצורפים',
  aiSkillFilesDesc: 'קריאת קבצים שצורפו',
  aiSkillSearch: 'חיפוש ברשת',
  aiSkillSearchDesc: 'נתונים/עובדות עדכניות',
  aiSkillImage: 'תמונה (חיפוש/יצירה)',
  aiSkillImageDesc: 'חיפוש או יצירת תמונה',
  aiSkillMerge: 'מיזוג חוברות',
  aiSkillMergeDesc: 'מיזוג מספר חוברות',
  aiCmdTplBrief: 'תקציר משימה',
  aiCmdTplBriefDesc: 'מטרה, היקף, קריטריוני קבלה',
  aiCmdTplBriefInsert: 'מטרה:\nהיקף:\nנתונים/הפניות:\nאילוצים:\nקריטריוני קבלה:\nפורמט:',
  aiModeAsk: 'שאל',
  aiModeCraft: 'בצע',
  aiModePlan: 'תכנן',
  aiModeAskHint: 'קריאה בלבד',
  aiModeCraftHint: 'עריכה ישירה',
  aiModePlanHint: 'הצע תוכנית תחילה',
