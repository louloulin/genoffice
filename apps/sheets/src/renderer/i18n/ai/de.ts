...
export const de = {
  ...
  aiCmdGroupActions: 'Schnellaktionen',
  aiCmdGroupTemplates: 'Vorlagen',
  aiSkillWorkbook: 'Arbeitsmappe',
  aiSkillWorkbookDesc: 'Zellen lesen/schreiben, Formeln, Diagramme',
  aiSkillFiles: 'Anhänge',
  aiSkillFilesDesc: 'Hochgeladene Dateien lesen',
  aiSkillSearch: 'Websuche',
  aiSkillSearchDesc: 'Aktuelle Daten / Fakten',
  aiSkillImage: 'Bild (Suche/Gen)',
  aiSkillImageDesc: 'Bild suchen oder erzeugen',
  aiSkillMerge: 'Arbeitsmappen mischen',
  aiSkillMergeDesc: 'Mehrere Arbeitsmappen kombinieren',
  aiCmdTplBrief: 'Aufgaben-Briefing',
  aiCmdTplBriefDesc: 'Ziel, Umfang, Abnahme festhalten',
  aiCmdTplBriefInsert: 'Ziel:\nUmfang:\nDaten/Quellen:\nEinschränkungen:\nAbnahme:\nFormat:',
  aiModeAsk: 'Fragen',
  aiModeCraft: 'Machen',
  aiModePlan: 'Planen',
  aiModeAskHint: 'Nur Lesen, keine Änderungen',
  aiModeCraftHint: 'Mappe direkt ändern',
  aiModePlanHint: 'Plan vorschlagen',
