...
export const en = {
  ...
  aiCmdGroupActions: 'Quick actions',
  aiCmdGroupTemplates: 'Templates',
  aiSkillWorkbook: 'Workbook',
  aiSkillWorkbookDesc: 'Read/write cells, edit formulas, insert charts',
  aiSkillFiles: 'Attachments',
  aiSkillFilesDesc: 'Read files the user uploaded',
  aiSkillSearch: 'Web search',
  aiSkillSearchDesc: 'Look up fresh data / facts',
  aiSkillImage: 'Image search / gen',
  aiSkillImageDesc: 'Find or generate an image for the workbook',
  aiSkillMerge: 'Merge workbooks',
  aiSkillMergeDesc: 'Combine several workbooks into one',
  aiCmdTplBrief: 'Task brief',
  aiCmdTplBriefDesc: 'Pin down the goal, scope, and acceptance',
  aiCmdTplBriefInsert: 'Goal:\nScope:\nData/Refs:\nConstraints:\nAcceptance:\nOutput format:',
  aiModeAsk: 'Ask',
  aiModeCraft: 'Craft',
  aiModePlan: 'Plan',
  aiModeAskHint: 'Read-only Q&A, no edits',
  aiModeCraftHint: 'Edit the workbook directly',
  aiModePlanHint: 'Propose a plan before changing anything',
