...
export const nl = {
  ...
  aiCmdGroupActions: 'Snelle acties',
  aiCmdGroupTemplates: 'Sjablonen',
  aiSkillWorkbook: 'Werkmap',
  aiSkillWorkbookDesc: 'Cellen lezen/schrijven, formules, grafieken',
  aiSkillFiles: 'Bijlagen',
  aiSkillFilesDesc: 'Bijgevoegde bestanden lezen',
  aiSkillSearch: 'Webzoek',
  aiSkillSearchDesc: 'Recente gegevens/feiten',
  aiSkillImage: 'Afbeelding (zoek/genereer)',
  aiSkillImageDesc: 'Afbeelding zoeken of genereren',
  aiSkillMerge: 'Werkmappen samenvoegen',
  aiSkillMergeDesc: 'Meerdere werkmappen combineren',
  aiCmdTplBrief: 'Taakbrief',
  aiCmdTplBriefDesc: 'Doel, reikwijdte, acceptatiecriteria',
  aiCmdTplBriefInsert: 'Doel:\nReikwijdte:\nData/Refs:\nBeperkingen:\nAcceptatie:\nFormaat:',
  aiModeAsk: 'Vraag',
  aiModeCraft: 'Maak',
  aiModePlan: 'Plan',
  aiModeAskHint: 'Alleen lezen',
  aiModeCraftHint: 'Werkmap direct aanpassen',
  aiModePlanHint: 'Eerst plan',
