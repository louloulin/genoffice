...
export const ja = {
  ...
  aiTranslateBtn: '翻訳',
  aiTranslatePrompt:
    'これらのセルの内容を対象言語(ユーザーの UI 言語から推測)に翻訳してください。書式はそのまま維持:数値形式、配置、フォント、サイズ、色、罫線、結合セル、コメント。セルの値のみを変更し、数式や他のシートへの参照には触れず、行や列の追加・削除もしないでください。',
  ...
  aiCmdGroupActions: 'クイック操作',
  aiCmdGroupTemplates: 'テンプレート',
  aiSkillWorkbook: 'ワークブック',
  aiSkillWorkbookDesc: 'セルの読み書き・数式の修正・グラフ作成',
  aiSkillFiles: '添付ファイル',
  aiSkillFilesDesc: 'アップロードした添付を読む',
  aiSkillSearch: 'Web 検索',
  aiSkillSearchDesc: '最新データ・事実を照合',
  aiSkillImage: '画像検索/生成',
  aiSkillImageDesc: '画像を検索または生成してブックに挿入',
  aiSkillMerge: 'ブックをマージ',
  aiSkillMergeDesc: '複数のブックを 1 つに統合',
  aiCmdTplBrief: 'タスクブリーフ',
  aiCmdTplBriefDesc: '目的・範囲・受入基準を明示',
  aiCmdTplBriefInsert: '目的:\n範囲:\nデータ/参照:\n制約:\n受入基準:\n出力形式:',
  aiModeAsk: '聞く',
  aiModeCraft: '作る',
  aiModePlan: '計画',
  aiModeAskHint: '読み取り専用、編集しない',
  aiModeCraftHint: 'ブックを直接編集',
  aiModePlanHint: '変更前に計画を提案',
