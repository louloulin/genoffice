...
export const ru = {
  ...
  aiTranslatePrompt:
    'Переведите содержимое этих ячеек на целевой язык (определяется по языку интерфейса пользователя). Сохраните всё форматирование: числовые форматы, выравнивание, шрифт, размер, цвет, границы, объединённые ячейки, примечания. Изменяйте только значение ячейки; не трогайте формулы и ссылки на другие листы, не добавляйте и не удаляйте строки или столбцы.',
  ...
  aiCmdGroupActions: 'Быстрые действия',
  aiCmdGroupTemplates: 'Шаблоны',
  aiSkillWorkbook: 'Книга',
  aiSkillWorkbookDesc: 'Читать/писать ячейки, формулы, графики',
  aiSkillFiles: 'Вложения',
  aiSkillFilesDesc: 'Читать прикреплённые файлы',
  aiSkillSearch: 'Веб-поиск',
  aiSkillSearchDesc: 'Свежие данные/факты',
  aiSkillImage: 'Изображение (поиск/генерация)',
  aiSkillImageDesc: 'Найти или сгенерировать изображение',
  aiSkillMerge: 'Объединить книги',
  aiSkillMergeDesc: 'Объединить несколько книг',
  aiCmdTplBrief: 'Бриф задачи',
  aiCmdTplBriefDesc: 'Цель, рамки, критерии',
  aiCmdTplBriefInsert: 'Цель:\nРамки:\nДанные/Источники:\nОграничения:\nКритерии:\nФормат:',
  aiModeAsk: 'Спросить',
  aiModeCraft: 'Сделать',
  aiModePlan: 'Спланировать',
  aiModeAskHint: 'Только чтение',
  aiModeCraftHint: 'Изменить книгу',
  aiModePlanHint: 'Сначала план',
