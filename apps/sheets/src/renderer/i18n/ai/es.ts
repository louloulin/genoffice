...
export const es = {
  ...
  aiCmdGroupActions: 'Acciones rápidas',
  aiCmdGroupTemplates: 'Plantillas',
  aiSkillWorkbook: 'Libro',
  aiSkillWorkbookDesc: 'Leer/escribir celdas, fórmulas, gráficos',
  aiSkillFiles: 'Adjuntos',
  aiSkillFilesDesc: 'Leer archivos adjuntos',
  aiSkillSearch: 'Búsqueda web',
  aiSkillSearchDesc: 'Datos / hechos recientes',
  aiSkillImage: 'Imagen (buscar/generar)',
  aiSkillImageDesc: 'Buscar o generar una imagen',
  aiSkillMerge: 'Combinar libros',
  aiSkillMergeDesc: 'Combinar varios libros',
  aiCmdTplBrief: 'Brief de tarea',
  aiCmdTplBriefDesc: 'Objetivo, alcance y criterios',
  aiCmdTplBriefInsert: 'Objetivo:\nAlcance:\nDatos/Refs:\nRestricciones:\nAceptación:\nFormato:',
  aiModeAsk: 'Preguntar',
  aiModeCraft: 'Hacer',
  aiModePlan: 'Planear',
  aiModeAskHint: 'Sólo lectura, sin cambios',
  aiModeCraftHint: 'Modificar el libro',
  aiModePlanHint: 'Proponer plan',
