...
export const th = {
  ...
  aiTranslateBtn: 'แปล',
  aiTranslatePrompt:
    'แปลเนื้อหาของเซลล์เหล่านี้เป็นภาษาเป้าหมาย (อนุมานจากภาษา UI ของผู้ใช้) รักษารูปแบบทั้งหมดไว้: รูปแบบตัวเลข การจัดแนว ฟอนต์ ขนาด สี เส้นขอบ เซลล์ที่ผสาน ความคิดเห็น เปลี่ยนเฉพาะค่าของเซลล์ อย่าแตะสูตรหรือการอ้างอิงไปยังเวิร์กชีตอื่น และอย่าเพิ่มหรือลบแถว/คอลัมน์',
  ...
  aiCmdGroupActions: 'คำสั่งด่วน',
  aiCmdGroupTemplates: 'เทมเพลต',
  aiSkillWorkbook: 'สมุดงาน',
  aiSkillWorkbookDesc: 'อ่าน/เขียนเซลล์ สูตร แผนภูมิ',
  aiSkillFiles: 'ไฟล์แนบ',
  aiSkillFilesDesc: 'อ่านไฟล์ที่แนบ',
  aiSkillSearch: 'ค้นหาเว็บ',
  aiSkillSearchDesc: 'ข้อมูล/ข้อเท็จจริงล่าสุด',
  aiSkillImage: 'ค้นหา/สร้างรูปภาพ',
  aiSkillImageDesc: 'ค้นหาหรือสร้างภาพ',
  aiSkillMerge: 'ผสานสมุดงาน',
  aiSkillMergeDesc: 'รวมสมุดงานหลายเล่มเป็นหนึ่งเดียว',
  aiCmdTplBrief: 'สรุปงาน',
  aiCmdTplBriefDesc: 'ระบุเป้าหมาย ขอบเขต เกณฑ์ยอมรัับ',
  aiCmdTplBriefInsert: 'เป้าหมาย:\nขอบเขต:\nข้อมูล/อ้างอิง:\nข้อจำกัด:\nเกณฑ์ยอมรัับ:\nรูปแบบผลลัพธ์:',
  aiModeAsk: 'ถาม',
  aiModeCraft: 'ทำ',
  aiModePlan: 'วางแผน',
  aiModeAskHint: 'อ่านอย่างเดียว',
  aiModeCraftHint: 'แก้ไขสมุดงานโดยตรง',
  aiModePlanHint: 'เสนอแผนก่อน',
