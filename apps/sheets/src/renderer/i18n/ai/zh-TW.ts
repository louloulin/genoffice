...
export const zhTW = {
  ...
  aiAnalyzePrompt: '分析這個表格的資料,總結關鍵發現、趨勢和異常',
    aiTranslateBtn: '翻譯',
  aiTranslatePrompt:
    '把這些儲存格內容翻譯成目標語言(依使用者介面語系判斷)。保留所有格式:數字格式、對齊、字型、字號、顏色、邊框、合併儲存格、註解。僅修改儲存格值,不要動公式、其他工作表的參照,也不要新增或刪除行列。',
  ...
  aiSkillWorkbook: '工作表',
  aiSkillWorkbookDesc: '讀寫工作簿、修改公式、產生圖表等',
  aiSkillFiles: '附件閱讀',
  aiSkillFilesDesc: '讀取使用者上傳的附件',
  aiSkillSearch: '聯網搜尋',
  aiSkillSearchDesc: '查最新資料/事實,避免模型編造',
  aiSkillImage: '圖片搜尋/生成',
  aiSkillImageDesc: '搜尋或產生圖片插入到工作簿',
  aiSkillMerge: '合併工作簿',
  aiSkillMergeDesc: '把多個工作簿合併成一張表',
  aiCmdTplBrief: '任務簡報',
  aiCmdTplBriefDesc: '明確目標、範圍與驗收標準',
  aiCmdTplBriefInsert: '目標:\n範圍:\n資料/參考:\n約束:\n驗收標準:\n輸出格式:',
  aiModeAsk: '問一問',
  aiModeCraft: '做一做',
  aiModePlan: '想一想',
  aiModeAskHint: '唯讀問答,不動資料',
  aiModeCraftHint: '直接修改工作簿',
  aiModePlanHint: '先列計劃再開動',
