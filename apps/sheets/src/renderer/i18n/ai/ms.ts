...
export const ms = {
  ...
  aiCmdGroupActions: 'Tindakan pantas',
  aiCmdGroupTemplates: 'Templat',
  aiSkillWorkbook: 'Buku kerja',
  aiSkillWorkbookDesc: 'Baca/tulis sel, formula, carta',
  aiSkillFiles: 'Lampiran',
  aiSkillFilesDesc: 'Baca fail yang dilampirkan',
  aiSkillSearch: 'Carian web',
  aiSkillSearchDesc: 'Data/fakta terkini',
  aiSkillImage: 'Imej (cari/jana)',
  aiSkillImageDesc: 'Cari atau jana imej',
  aiSkillMerge: 'Gabung buku kerja',
  aiSkillMergeDesc: 'Gabungkan beberapa buku kerja',
  aiCmdTplBrief: 'Ringkasan tugas',
  aiCmdTplBriefDesc: 'Matlamat, skop, kriteria',
  aiCmdTplBriefInsert: 'Matlamat:\nSkop:\nData/Rujukan:\nHad:\nKriteria:\nFormat:',
  aiModeAsk: 'Tanya',
  aiModeCraft: 'Buat',
  aiModePlan: 'Rancang',
  aiModeAskHint: 'Baca sahaja',
  aiModeCraftHint: 'Ubah buku kerja',
  aiModePlanHint: 'Cadang rancangan dulu',
