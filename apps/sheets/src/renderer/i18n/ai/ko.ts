...
export const ko = {
  ...
  aiAnalyzePrompt: '이 시트의 데이터를 분석하고 주요 발견 사항, 추세, 이상값을 요약해 주세요',
    aiTranslateBtn: '번역',
  aiTranslatePrompt:
    '이 셀들의 내용을 대상 언어(사용자 UI 언어에서 추론)로 번역하세요. 모든 서식을 유지합니다: 숫자 서식, 정렬, 글꼴, 크기, 색, 테두리, 병합 셀, 메모. 셀 값만 바꾸고, 수식이나 다른 워크시트 참조는 건드리지 말며, 행/열을 추가하거나 삭제하지 마세요.',
  ...
  aiCmdGroupSkills: '스킬',
  aiCmdGroupActions: '빠른 작업',
  aiCmdGroupTemplates: '템플릿',
  aiSkillWorkbook: '통합 문서',
  aiSkillWorkbookDesc: '셀 읽기/쓰기, 수식 수정, 차트 생성',
  aiSkillFiles: '첨부 파일',
  aiSkillFilesDesc: '업로드된 첨부 파일 읽기',
  aiSkillSearch: '웹 검색',
  aiSkillSearchDesc: '최신 데이터/사실 확인',
  aiSkillImage: '이미지 검색/생성',
  aiSkillImageDesc: '이미지를 검색하거나 생성하여 통합 문서에 삽입',
  aiSkillMerge: '통합 문서 병합',
  aiSkillMergeDesc: '여러 통합 문서를 하나로 합치기',
  aiCmdTplBrief: '작업 브리프',
  aiCmdTplBriefDesc: '목표, 범위, 합격 기준 명시',
  aiCmdTplBriefInsert: '목표:\n범위:\n데이터/참조:\n제약:\n합격 기준:\n출력 형식:',
  aiModeAsk: '질문',
  aiModeCraft: '실행',
  aiModePlan: '계획',
  aiModeAskHint: '읽기 전용, 수정 안 함',
  aiModeCraftHint: '통합 문서를 직접 수정',
  aiModePlanHint: '변경 전에 계획 제안',
