...
export const id = {
  ...
  aiCmdGroupActions: 'Aksi cepat',
  aiCmdGroupTemplates: 'Template',
  aiSkillWorkbook: 'Workbook',
  aiSkillWorkbookDesc: 'Baca/tulis sel, rumus, bagan',
  aiSkillFiles: 'Lampiran',
  aiSkillFilesDesc: 'Baca lampiran',
  aiSkillSearch: 'Pencarian web',
  aiSkillSearchDesc: 'Data/fakta terbaru',
  aiSkillImage: 'Cari/buat gambar',
  aiSkillImageDesc: 'Cari atau buat gambar',
  aiSkillMerge: 'Gabungkan workbook',
  aiSkillMergeDesc: 'Gabungkan beberapa workbook',
  aiCmdTplBrief: 'Ringkasan tugas',
  aiCmdTplBriefDesc: 'Tujuan, cakupan, kriteria',
  aiCmdTplBriefInsert: 'Tujuan:\nCakupan:\nData/Ref:\nBatasan:\nKriteria:\nFormat:',
  aiModeAsk: 'Tanya',
  aiModeCraft: 'Kerjakan',
  aiModePlan: 'Rencanakan',
  aiModeAskHint: 'Baca saja',
  aiModeCraftHint: 'Ubah workbook langsung',
  aiModePlanHint: 'Usulkan rencana dulu',
