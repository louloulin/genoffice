...
export const fr = {
  ...
  aiCmdGroupActions: 'Actions rapides',
  aiCmdGroupTemplates: 'Modèles',
  aiSkillWorkbook: 'Classeur',
  aiSkillWorkbookDesc: 'Lire/écrire cellules, formules, graphiques',
  aiSkillFiles: 'Pièces jointes',
  aiSkillFilesDesc: 'Lire les fichiers envoyés',
  aiSkillSearch: 'Recherche web',
  aiSkillSearchDesc: 'Données / faits récents',
  aiSkillImage: 'Image (recherche/génération)',
  aiSkillImageDesc: 'Trouver ou générer une image pour le classeur',
  aiSkillMerge: 'Fusionner des classeurs',
  aiSkillMergeDesc: 'Combiner plusieurs classeurs',
  aiCmdTplBrief: 'Brief de tâche',
  aiCmdTplBriefDesc: 'Cadrer objectif, périmètre, critères d\'acceptation',
  aiCmdTplBriefInsert: 'Objectif :\nPérimètre :\nDonnées/Réfs :\nContraintes :\nCritères :\nFormat :',
  aiModeAsk: 'Demander',
  aiModeCraft: 'Faire',
  aiModePlan: 'Planifier',
  aiModeAskHint: 'Lecture seule, pas de modification',
  aiModeCraftHint: 'Modifier le classeur directement',
  aiModePlanHint: 'Proposer un plan avant de modifier',
