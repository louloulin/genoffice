...
export const pt = {
  ...
  aiCmdGroupActions: 'Ações rápidas',
  aiCmdGroupTemplates: 'Modelos',
  aiSkillWorkbook: 'Pasta',
  aiSkillWorkbookDesc: 'Ler/escrever células, fórmulas, gráficos',
  aiSkillFiles: 'Anexos',
  aiSkillFilesDesc: 'Ler ficheiros anexados',
  aiSkillSearch: 'Pesquisa web',
  aiSkillSearchDesc: 'Dados / factos recentes',
  aiSkillImage: 'Imagem (buscar/gerar)',
  aiSkillImageDesc: 'Procurar ou gerar imagem',
  aiSkillMerge: 'Combinar pastas',
  aiSkillMergeDesc: 'Combinar várias pastas',
  aiCmdTplBrief: 'Brief da tarefa',
  aiCmdTplBriefDesc: 'Objetivo, âmbito, critérios',
  aiCmdTplBriefInsert: 'Objetivo:\nÂmbito:\nDados/Refs:\nRestrições:\nAceitação:\nFormato:',
  aiModeAsk: 'Perguntar',
  aiModeCraft: 'Fazer',
  aiModePlan: 'Planear',
  aiModeAskHint: 'Só leitura',
  aiModeCraftHint: 'Modificar a pasta',
  aiModePlanHint: 'Propor plano',
