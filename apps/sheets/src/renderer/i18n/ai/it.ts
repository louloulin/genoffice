...
export const it = {
  ...
  aiTranslatePrompt:
    'Traduci il contenuto di queste celle nella lingua di destinazione (desumila dalla lingua dell’interfaccia utente). Conserva tutta la formattazione: formati numerici, allineamento, carattere, dimensione, colore, bordi, celle unite, commenti. Modifica solo il valore della cella; non toccare formule né riferimenti ad altri fogli e non aggiungere o rimuovere righe o colonne.',
  ...
  aiCmdGroupSkills: 'Skill',
  aiCmdGroupActions: 'Azioni rapide',
  aiCmdGroupTemplates: 'Modelli',
  aiSkillWorkbook: 'Cartella di lavoro',
  aiSkillWorkbookDesc: 'Leggere/scrivere celle, formule, grafici',
  aiSkillFiles: 'Allegati',
  aiSkillFilesDesc: 'Leggere file allegati',
  aiSkillSearch: 'Ricerca web',
  aiSkillSearchDesc: 'Dati / fatti recenti',
  aiSkillImage: 'Immagine (cerca/genera)',
  aiSkillImageDesc: 'Trova o genera immagine',
  aiSkillMerge: 'Unisci cartelle',
  aiSkillMergeDesc: 'Combina più cartelle',
  aiCmdTplBrief: 'Brief del task',
  aiCmdTplBriefDesc: 'Obiettivo, perimetro, accettazione',
  aiCmdTplBriefInsert: 'Obiettivo:\nPerimetro:\nDati/Refs:\nVincoli:\nAccettazione:\nFormato:',
  aiModeAsk: 'Chiedi',
  aiModeCraft: 'Fai',
  aiModePlan: 'Pianifica',
  aiModeAskHint: 'Sola lettura',
  aiModeCraftHint: 'Modifica la cartella',
  aiModePlanHint: 'Proponi piano',
