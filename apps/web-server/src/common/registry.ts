/**
 * Common registry: shared IPC handler registration + transport encoding.
 *
 * The web-server duplicates @genoffice/ipc-bridge's binary codec locally
 * because it does not depend on Electron. Module split keeps the codec
 * accessible to every capability module without circular imports.
 */
...
// =============================================================================
// Binary transport codec (mirrors @genoffice/ipc-bridge's tagged base64 layer).
// =============================================================================
