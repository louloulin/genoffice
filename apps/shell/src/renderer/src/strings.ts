...
export const strings = {
  zh: {
    ...
    setCloudOpenMode: '云项目打开方式',
    setCloudOpenModeDesc: '点击主页 Genspark 项目时默认的打开方式。⌘/Ctrl+点击仍可用新窗口打开,Shift+点击可用浏览器打开。',
    setCloudOpenModeTab: '在标签页中打开',
    setCloudOpenModeWindow: '在新窗口中打开',
    setCloudOpenModeExternal: '在系统浏览器中打开',
  ...
  en: {
    ...
    uploadHint: 'Upload local files to the current project',
    ...
    setCloudOpenMode: 'Open cloud projects in',
    setCloudOpenModeDesc: 'Default way to open Genspark projects from Home. ⌘/Ctrl+click still opens a new window; Shift+click still opens the system browser.',
    setCloudOpenModeTab: 'Tab in this window',
    setCloudOpenModeWindow: 'New window',
    setCloudOpenModeExternal: 'System browser',
  ...
  ja: {
    ...
    uploadHint: 'ローカルファイルを現在のプロジェクトにアップロード',
    ...
    setCloudOpenMode: 'クラウドプロジェクトの開き方',
    setCloudOpenModeDesc: 'ホームの Genspark プロジェクトを開く既定の方法。⌘/Ctrl+クリックで新しいウィンドウ、Shift+クリックでブラウザも使用可能。',
    setCloudOpenModeTab: 'このウィンドウのタブで開く',
    setCloudOpenModeWindow: '新しいウィンドウで開く',
    setCloudOpenModeExternal: 'システムブラウザで開く',
  ...
  ko: {
    ...
    openLocal: '로컬 파일 열기',
    uploadFile: '파일 업로드',
    uploadHint: '로컬 파일을 현재 프로젝트에 업로드',
    ...
    setCloudOpenMode: '클라우드 프로젝트 열기',
    setCloudOpenModeDesc: '홈에서 Genspark 프로젝트를 열 때 기본 방식. ⌘/Ctrl+클릭: 새 창, Shift+클릭: 브라우저.',
    setCloudOpenModeTab: '이 창의 탭에서 열기',
    setCloudOpenModeWindow: '새 창에서 열기',
    setCloudOpenModeExternal: '시스템 브라우저에서 열기',
  ...
  fr: {
    ...
    uploadHint: 'Téléverser des fichiers locaux dans le projet actuel',
    ...
    setCloudOpenMode: 'Ouvrir les projets cloud dans',
    setCloudOpenModeDesc: 'Mode d’ouverture par défaut des projets Genspark depuis l’accueil. ⌘/Ctrl+clic : nouvelle fenêtre ; Maj+clic : navigateur.',
    setCloudOpenModeTab: 'Onglet dans cette fenêtre',
    setCloudOpenModeWindow: 'Nouvelle fenêtre',
    setCloudOpenModeExternal: 'Navigateur système',
  ...
  de: {
    ...
    uploadHint: 'Lokale Dateien in das aktuelle Projekt hochladen',
    ...
    setCloudOpenMode: 'Cloud-Projekte öffnen in',
    setCloudOpenModeDesc: 'Standardmethode zum Öffnen von Genspark-Projekten von der Startseite. ⌘/Strg+Klick öffnet weiter ein neues Fenster, Umschalt+Klick den Browser.',
    setCloudOpenModeTab: 'Tab in diesem Fenster',
    setCloudOpenModeWindow: 'Neues Fenster',
    setCloudOpenModeExternal: 'System-Browser',
  ...
  es: {
    ...
    uploadHint: 'Sube archivos locales al proyecto actual',
    ...
    setCloudOpenMode: 'Abrir proyectos en la nube en',
    setCloudOpenModeDesc: 'Modo predeterminado para abrir proyectos de Genspark desde Inicio. ⌘/Ctrl+clic sigue abriendo una ventana nueva; Mayús+clic el navegador.',
    setCloudOpenModeTab: 'Pestaña en esta ventana',
    setCloudOpenModeWindow: 'Ventana nueva',
    setCloudOpenModeExternal: 'Navegador del sistema',
  ...
  th: {
    ...
    uploadHint: 'อัปโหลดไฟล์ในเครื่องไปยังโปรเจ็กต์ปัจจุบัน',
    ...
    setCloudOpenMode: 'เปิดโปรเจกต์คลาวด์ใน',
    setCloudOpenModeDesc: 'วิธีเปิดโปรเจกต์ Genspark จากหน้าหลัก. ⌘/Ctrl+คลิก: หน้าต่างใหม่, Shift+คลิก: เบราว์เซอร์.',
    setCloudOpenModeTab: 'แท็บในหน้าต่างนี้',
    setCloudOpenModeWindow: 'หน้าต่างใหม่',
    setCloudOpenModeExternal: 'เบราว์เซอร์ของระบบ',
  ...
  id: {
    ...
    uploadHint: 'Unggah file lokal ke proyek saat ini',
    ...
    setCloudOpenMode: 'Buka proyek cloud di',
    setCloudOpenModeDesc: 'Cara default membuka proyek Genspark dari Beranda. ⌘/Ctrl+klik: jendela baru; Shift+klik: browser.',
    setCloudOpenModeTab: 'Tab di jendela ini',
    setCloudOpenModeWindow: 'Jendela baru',
    setCloudOpenModeExternal: 'Browser sistem',
  ...
  ru: {
    ...
    uploadHint: 'Загрузить локальные файлы в текущий проект',
    ...
    setCloudOpenMode: 'Открывать облачные проекты в',
    setCloudOpenModeDesc: 'Способ по умолчанию для открытия проектов Genspark из Дома. ⌘/Ctrl+клик: новое окно; Shift+клик: браузер.',
    setCloudOpenModeTab: 'Вкладка в этом окне',
    setCloudOpenModeWindow: 'Новое окно',
    setCloudOpenModeExternal: 'Системный браузер',
  ...
  ar: {
    ...
    uploadFile: 'رفع ملف',
    uploadHint: 'ارفع الملفات المحلية إلى المشروع الحالي',
    ...
    setCloudOpenMode: 'فتح مشاريع السحابة في',
    setCloudOpenModeDesc: 'الطريقة الافتراضية لفتح مشاريع Genspark من الصفحة الرئيسية. ⌘/Ctrl+نقرة: نافذة جديدة; Shift+نقرة: المتصفح.',
    setCloudOpenModeTab: 'علامة تبويب في هذه النافذة',
    setCloudOpenModeWindow: 'نافذة جديدة',
    setCloudOpenModeExternal: 'متصفح النظام',
  ...
  pt: {
    ...
    uploadHint: 'Enviar arquivos locais para o projeto atual',
    ...
    setCloudOpenMode: 'Abrir projetos na nuvem em',
    setCloudOpenModeDesc: 'Modo padrão de abrir projetos Genspark a partir do Início. ⌘/Ctrl+clique: nova janela; Shift+clique: navegador.',
    setCloudOpenModeTab: 'Separador nesta janela',
    setCloudOpenModeWindow: 'Nova janela',
    setCloudOpenModeExternal: 'Navegador do sistema',
  ...
  it: {
    ...
    uploadHint: 'Carica file locali nel progetto corrente',
    ...
    setCloudOpenMode: 'Apri i progetti cloud in',
    setCloudOpenModeDesc: 'Modo predefinito per aprire i progetti Genspark dalla Home. ⌘/Ctrl+clic: nuova finestra; Shift+clic: browser.',
    setCloudOpenModeTab: 'Scheda in questa finestra',
    setCloudOpenModeWindow: 'Nuova finestra',
    setCloudOpenModeExternal: 'Browser di sistema',
  ...
  pl: {
    ...
    uploadHint: 'Prześlij lokalne pliki do bieżącego projektu',
    ...
    setCloudOpenMode: 'Otwieraj projekty w chmurze w',
    setCloudOpenModeDesc: 'Domyślny sposób otwierania projektów Genspark z głównej. ⌘/Ctrl+klik: nowe okno; Shift+klik: przeglądarka.',
    setCloudOpenModeTab: 'Karta w tym oknie',
    setCloudOpenModeWindow: 'Nowe okno',
    setCloudOpenModeExternal: 'Przeglądarka systemowa',
  ...
  cs: {
    ...
    uploadHint: 'Nahrát místní soubory do aktuálního projektu',
    ...
    setCloudOpenMode: 'Otevírat cloudové projekty v',
    setCloudOpenModeDesc: 'Výchozí způsob otevírání projektů Genspark z Domů. ⌘/Ctrl+klik: nové okno; Shift+klik: prohlížeč.',
    setCloudOpenModeTab: 'Záložka v tomto okně',
    setCloudOpenModeWindow: 'Nové okno',
    setCloudOpenModeExternal: 'Systémový prohlížeč',
    settings: 'Nastavení',
    setSecAccount: 'Účet',
  ...
  nl: {
    ...
    uploadHint: 'Upload lokale bestanden naar het huidige project',
    ...
    setCloudOpenMode: 'Cloudprojecten openen in',
    setCloudOpenModeDesc: 'Standaardmanier om Genspark-projecten vanuit Home te openen. ⌘/Ctrl+klik: nieuw venster; Shift+klik: browser.',
    setCloudOpenModeTab: 'Tabblad in dit venster',
    setCloudOpenModeWindow: 'Nieuw venster',
    setCloudOpenModeExternal: 'Systeembrowser',
  ...
  ms: {
    ...
    uploadHint: 'Muat naik fail setempat ke projek semasa',
    dropToOpenTitle: 'Lepaskan untuk membuka',
    greetMorning: 'Selamat pagi',
    ...
    setCloudOpenMode: 'Buka projek awan dalam',
    setCloudOpenModeDesc: 'Cara lalai membuka projek Genspark dari Rumah. ⌘/Ctrl+klik: tetingkap baharu; Shift+klik: pelayar.',
    setCloudOpenModeTab: 'Tab dalam tetingkap ini',
    setCloudOpenModeWindow: 'Tetingkap baharu',
    setCloudOpenModeExternal: 'Pelayar sistem',
  ...
  he: {
    ...
    uploadHint: 'העלה קבצים מקומיים לפרויקט הנוכחי',
    ...
    setCloudOpenMode: 'פתח פרויקטי ענן ב',
    setCloudOpenModeDesc: 'דרך ברירת המחדל לפתיחת פרויקטים של Genspark מדף הבית. ⌘/Ctrl+לחיצה: חלון חדש; Shift+לחיצה: דפדפן.',
    setCloudOpenModeTab: 'כרטיסייה בחלון זה',
    setCloudOpenModeWindow: 'חלון חדש',
    setCloudOpenModeExternal: 'דפדפן המערכת',
  ...
  hi: {
    ...
    uploadHint: 'स्थानीय फ़ाइलों को वर्तमान प्रोजेक्ट में अपलोड करें',
    ...
    setCloudOpenMode: 'क्लाउड प्रोजेक्ट कहाँ खोलें',
    setCloudOpenModeDesc: 'होम से Genspark प्रोजेक्ट खोलने का डिफ़ॉल्ट तरीका. ⌘/Ctrl+क्लिक: नई विंडो; Shift+क्लिक: ब्राउज़र.',
    setCloudOpenModeTab: 'इस विंडो में टैब',
    setCloudOpenModeWindow: 'नई विंडो',
    setCloudOpenModeExternal: 'सिस्टम ब्राउज़र',
  ...
  'zh-TW': {
    ...
    setCloudOpenMode: '雲端專案開啟方式',
    setCloudOpenModeDesc: '從首頁開啟 Genspark 專案的預設方式。⌘/Ctrl+點擊仍可開新視窗,Shift+點擊仍可用瀏覽器。',
    setCloudOpenModeTab: '在此視窗的分頁中開啟',
    setCloudOpenModeWindow: '在新視窗中開啟',
    setCloudOpenModeExternal: '在系統瀏覽器中開啟',
    setAiFontSize: 'AI 面板文字大小',
