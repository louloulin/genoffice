...
export function createSlidesApi(t: IpcTransport, overrides: SlidesApiOverrides = {}): SlidesApi {
  return {
    ...
    consumePendingOpen:
      overrides.consumePendingOpen ??
      ((fitWidthPx) => t.invoke('slides:consume-pending-open', fitWidthPx)),
    ...
    landGeneratedPages: (
      ...
      atIndex?: number,
      deckName?: string,
    ) => t.invoke('slides:land-generated-pages', pageMarkers, fitWidthPx, mode, atIndex, deckName),
    ...
    localGeneratePage: (op: { specJson: string }) => t.invoke('slides:local-page-generate', op),
    ...
    editPictureSrcRect: (op: EditPictureSrcRectOp) => t.invoke('slides:edit-picture-src-rect', op),
    editPictureOpacity: (op: EditPictureOpacityOp) => t.invoke('slides:edit-picture-opacity', op),
    ...
    batchEditTransform: (op: BatchEditTransformOp) => t.invoke('slides:batch-edit-transform', op),
    ...
    addSlideWithLayout: (op: AddSlideWithLayoutOp) => t.invoke('slides:add-slide-with-layout', op),
    ...
    setTableColWidth: (op: SetTableColWidthOp) => t.invoke('slides:set-table-col-width', op),
    setTableRowHeight: (op: SetTableRowHeightOp) => t.invoke('slides:set-table-row-height', op),
    setTableCellAnchor: (op: SetTableCellAnchorOp) => t.invoke('slides:set-table-cell-anchor', op),
    ...
    duplicateElements: (op: DuplicateElementsOp) => t.invoke('slides:duplicate-elements', op),
    ...
    getHeaderFooter: (slideIndex: number) => t.invoke('slides:get-header-footer', slideIndex),
    ...
    exportImages:
      overrides.exportImages ?? ((op: ExportImagesOp) => t.invoke('slides:export-images', op)),
    pickExportPdfPath:
      overrides.pickExportPdfPath ??
    ...
    onHistoryChanged: (handler: (state: { canUndo: boolean; canRedo: boolean }) => void) =>
      t.on('slides:history-changed', (state) =>
        handler(state as { canUndo: boolean; canRedo: boolean }),
      ),
    onDeckChanged: (
