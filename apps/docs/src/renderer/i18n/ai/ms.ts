...
export const ms = {
  ...
  aiCmdSkillDocsDesc: 'Baca, sisip, ganti, format, perubahan dan komen',
  aiCmdSkillFiles: 'Bacaan lampiran',
  aiCmdSkillFilesDesc: 'Baca teks lampiran yang dimuat naik',
  aiCmdSkillWeb: 'Carian web',
  aiCmdSkillWebDesc: 'Sokong jawapan dengan sumber terkini',
  aiCmdSkillImage: 'Carian imej',
  aiCmdSkillImageDesc: 'Cari imej untuk disisipkan',
  aiCmdSkillDraw: 'Jana imej',
  aiCmdSkillDrawDesc: 'Jana dan sisip ilustrasi daripada penerangan',
  aiCmdTplBrief: 'Templat tugasan',
  aiCmdTplBriefDesc: 'Matlamat / input / tindakan / kekangan / output / kriteria penerimaan',
  aiCmdTplBriefInsert: 'Matlamat:\nInput:\nTindakan:\nKekangan:\nOutput:\nKriteria penerimaan:',
  aiActiveSkill: 'Kemahiran aktif',
  aiActiveSkillClear: 'Buang kemahiran ini',
