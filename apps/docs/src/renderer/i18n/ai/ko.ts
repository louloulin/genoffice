...
export const ko = {
  ...
  aiInlineLauncherShorten: '줄이기',
  aiInlineLauncherTranslate: '번역',
  aiInlineLauncherSummarize: '요약',
  aiTranslateDialogTitle: '선택 영역 번역',
  aiTranslateTargetLang: '번역 대상 언어',
  aiTranslateSourceLang: '감지된 원본 언어',
  aiTranslatePreserveFormat: '원본 서식(글꼴/크기/정렬/표) 유지',
  aiTranslateSwapLanguages: '교환',
  aiTranslateStart: '번역',
  aiTranslateOriginal: '원문',
  aiTranslateTranslated: '번역문',
  aiTranslateUndo: '번역 취소',
  aiTranslateUndoFailed: '번역을 취소할 수 없습니다',
  aiTranslatePreviewTitle: '미리보기',
  aiTranslatePreviewLoading: '번역 중…',
  aiTranslateUnsupported: '번역 실패(다시 시도하거나 「설정 → AI」에서 API 키와 모델을 확인하세요)',
  ...
  aiCmdSkillDocsDesc: '읽기·삽입·바꾸기·서식·변경 내용 추적·댓글',
  aiCmdSkillFiles: '첨부 읽기',
  aiCmdSkillFilesDesc: '업로드한 첨부의 본문을 읽습니다',
  aiCmdSkillWeb: '웹 검색',
  aiCmdSkillWebDesc: '최신 웹 자료로 답변을 보강합니다',
  aiCmdSkillImage: '이미지 검색',
  aiCmdSkillImageDesc: '삽입할 이미지를 찾습니다',
  aiCmdSkillDraw: '이미지 생성',
  aiCmdSkillDrawDesc: '설명으로 삽화를 생성해 삽입합니다',
  aiCmdTplBrief: '작업 지시 템플릿',
  aiCmdTplBriefDesc: '목표 / 입력 / 동작 / 제약 / 출력 / 검수 기준',
  aiCmdTplBriefInsert: '목표:\n입력:\n동작:\n제약:\n출력:\n검수 기준:',
  aiActiveSkill: '사용 중인 스킬',
  aiActiveSkillClear: '이 스킬 해제',
