...
export const nl = {
  ...
  aiCmdSkillDocsDesc: 'Lezen, invoegen, vervangen, opmaken, wijzigingen en opmerkingen',
  aiCmdSkillFiles: 'Bijlagen lezen',
  aiCmdSkillFilesDesc: 'Lees de tekst van geüploade bijlagen',
  aiCmdSkillWeb: 'Zoeken op het web',
  aiCmdSkillWebDesc: 'Onderbouw het antwoord met actuele bronnen',
  aiCmdSkillImage: 'Afbeeldingen zoeken',
  aiCmdSkillImageDesc: 'Zoek afbeeldingen om in te voegen',
  aiCmdSkillDraw: 'Afbeeldingen genereren',
  aiCmdSkillDrawDesc: 'Genereer en voeg een illustratie in op basis van een beschrijving',
  aiCmdTplBrief: 'Taakomschrijving',
  aiCmdTplBriefDesc: 'Doel / invoer / acties / beperkingen / resultaat / acceptatiecriteria',
  aiCmdTplBriefInsert: 'Doel:\nInvoer:\nActies:\nBeperkingen:\nResultaat:\nAcceptatiecriteria:',
  aiActiveSkill: 'Actieve vaardigheid',
  aiActiveSkillClear: 'Deze vaardigheid verwijderen',
