...
export const de = {
  ...
  aiInlineLauncherShorten: 'Kürzen',
  aiInlineLauncherTranslate: 'Übersetzen',
  aiInlineLauncherSummarize: 'Zusammenfassen',
  aiTranslateDialogTitle: 'Auswahl übersetzen',
  aiTranslateTargetLang: 'Übersetzen in',
  aiTranslateSourceLang: 'Erkannte Ausgangssprache',
  aiTranslatePreserveFormat: 'Originalformatierung (Schrift/Größe/Ausrichtung/Tabellen) beibehalten',
  aiTranslateSwapLanguages: 'Tauschen',
  aiTranslateStart: 'Übersetzen',
  aiTranslateOriginal: 'Original',
  aiTranslateTranslated: 'Übersetzung',
  aiTranslateUndo: 'Übersetzung rückgängig machen',
  aiTranslateUndoFailed: 'Übersetzung konnte nicht rückgängig gemacht werden',
  aiTranslatePreviewTitle: 'Vorschau',
  aiTranslatePreviewLoading: 'Wird übersetzt…',
  aiTranslateUnsupported: 'Übersetzung fehlgeschlagen (erneut versuchen oder API-Schlüssel und Modell unter Einstellungen → KI prüfen)',
  ...
  aiCmdSkillDocsDesc: 'Lesen, einfügen, ersetzen, formatieren, Änderungen und Kommentare',
  aiCmdSkillFiles: 'Anhang lesen',
  aiCmdSkillFilesDesc: 'Den Text hochgeladener Anhänge lesen',
  aiCmdSkillWeb: 'Websuche',
  aiCmdSkillWebDesc: 'Die Antwort mit aktuellen Quellen belegen',
  aiCmdSkillImage: 'Bildsuche',
  aiCmdSkillImageDesc: 'Bilder zum Einfügen finden',
  aiCmdSkillDraw: 'Bilder erzeugen',
  aiCmdSkillDrawDesc: 'Eine Abbildung nach Beschreibung erzeugen und einfügen',
  aiCmdTplBrief: 'Aufgabenbeschreibung',
  aiCmdTplBriefDesc: 'Ziel / Eingabe / Aktionen / Vorgaben / Ergebnis / Abnahmekriterien',
  aiCmdTplBriefInsert: 'Ziel:\nEingabe:\nAktionen:\nVorgaben:\nErgebnis:\nAbnahmekriterien:',
  aiActiveSkill: 'Aktiver Skill',
  aiActiveSkillClear: 'Diesen Skill entfernen',
