...
export const en = {
  ...
  aiCmdSkillDocsDesc: 'Read, insert, replace, format, track changes and comments',
  aiCmdSkillFiles: 'Attachment reading',
  aiCmdSkillFilesDesc: 'Read the text of the attachments you uploaded',
  aiCmdSkillWeb: 'Web search',
  aiCmdSkillWebDesc: 'Ground the answer in up-to-date sources',
  aiCmdSkillImage: 'Image search',
  aiCmdSkillImageDesc: 'Find images you can insert',
  aiCmdSkillDraw: 'Generate images',
  aiCmdSkillDrawDesc: 'Generate and insert an illustration from a description',
  aiCmdTplBrief: 'Task brief',
  aiCmdTplBriefDesc: 'Goal / input / actions / constraints / output / acceptance',
  aiCmdTplBriefInsert: 'Goal:\nInput:\nActions:\nConstraints:\nOutput:\nAcceptance:',
  aiActiveSkill: 'Active skill',
  aiActiveSkillClear: 'Clear this skill',
