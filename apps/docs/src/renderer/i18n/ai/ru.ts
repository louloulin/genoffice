...
export const ru = {
  ...
  aiInlineLauncherShorten: 'Сократить',
  aiInlineLauncherTranslate: 'Перевести',
  aiInlineLauncherSummarize: 'Суммировать',
  aiTranslateDialogTitle: 'Перевести выделение',
  aiTranslateTargetLang: 'Перевести на',
  aiTranslateSourceLang: 'Обнаружен исходный язык',
  aiTranslatePreserveFormat: 'Сохранить форматирование (шрифт/размер/выравнивание/таблицы)',
  aiTranslateSwapLanguages: 'Поменять местами',
  aiTranslateStart: 'Перевести',
  aiTranslateOriginal: 'Оригинал',
  aiTranslateTranslated: 'Перевод',
  aiTranslateUndo: 'Отменить перевод',
  aiTranslateUndoFailed: 'Не удалось отменить перевод',
  aiTranslatePreviewTitle: 'Предпросмотр',
  aiTranslatePreviewLoading: 'Перевод…',
  aiTranslateUnsupported: 'Сбой перевода (повторите попытку или проверьте ключ API и модель в Настройки → ИИ)',
  ...
  aiTranslateBtn: 'ИИ Перевод',
  aiTranslatePrompt: 'Переведите это содержимое на язык интерфейса пользователя, сохранив исходное форматирование (шрифт, размер, цвет, отступ, списки, заголовки, таблицы, выравнивание и т. д.). Если есть выделение — переведите только его; иначе переведите весь документ.',
  ...
  aiCmdSkillDocsDesc: 'Чтение, вставка, замена, форматирование, правки и комментарии',
  aiCmdSkillFiles: 'Чтение вложений',
  aiCmdSkillFilesDesc: 'Читать текст загруженных вложений',
  aiCmdSkillWeb: 'Веб-поиск',
  aiCmdSkillWebDesc: 'Подкреплять ответ свежими источниками',
  aiCmdSkillImage: 'Поиск изображений',
  aiCmdSkillImageDesc: 'Находить изображения для вставки',
  aiCmdSkillDraw: 'Генерация изображений',
  aiCmdSkillDrawDesc: 'Создать и вставить иллюстрацию по описанию',
  aiCmdTplBrief: 'Шаблон задачи',
  aiCmdTplBriefDesc: 'Цель / вход / действия / ограничения / результат / критерии приёмки',
  aiCmdTplBriefInsert: 'Цель:\nВход:\nДействия:\nОграничения:\nРезультат:\nКритерии приёмки:',
  aiActiveSkill: 'Активный навык',
  aiActiveSkillClear: 'Убрать этот навык',
