...
export const zhTW = {
  ...
  aiInlineLauncherShorten: '精簡',
  aiInlineLauncherTranslate: '翻譯',
  aiInlineLauncherSummarize: '摘要',
  aiTranslateDialogTitle: '翻譯選取內容',
  aiTranslateTargetLang: '翻譯為',
  aiTranslateSourceLang: '偵測到的來源語言',
  aiTranslatePreserveFormat: '保留原始格式（字型/大小/對齊/表格）',
  aiTranslateSwapLanguages: '互換',
  aiTranslateStart: '翻譯',
  aiTranslateOriginal: '原文',
  aiTranslateTranslated: '譯文',
  aiTranslateUndo: '復原翻譯',
  aiTranslateUndoFailed: '無法復原翻譯',
  aiTranslatePreviewTitle: '預覽',
  aiTranslatePreviewLoading: '翻譯中…',
  aiTranslateUnsupported: '翻譯失敗（請稍後重試，或在「設定 → AI」中檢查 API 金鑰與模型）',
  ...
  aiCmdSkillDocs: '文件編輯',
  aiCmdSkillDocsDesc: '讀取、插入、取代、排版、修訂與註解',
  aiCmdSkillFiles: '附件閱讀',
  aiCmdSkillFilesDesc: '讀取已上傳附件的內文',
  aiCmdSkillWeb: '聯網搜尋',
  aiCmdSkillWebDesc: '用最新網頁資料補足回答',
  aiCmdSkillImage: '圖片搜尋',
  aiCmdSkillImageDesc: '搜尋可插入的圖片素材',
  aiCmdSkillDraw: '生成配圖',
  aiCmdSkillDrawDesc: '依描述生成並插入插圖',
  aiCmdTplBrief: '任務說明範本',
  aiCmdTplBriefDesc: '目標 / 輸入 / 動作 / 限制 / 輸出 / 驗收',
  aiCmdTplBriefInsert: '目標:\n輸入:\n動作:\n限制:\n輸出:\n驗收標準:',
  aiActiveSkill: '已啟用技能',
  aiActiveSkillClear: '取消此技能',
