...
export const id = {
  ...
  aiCmdSkillDocsDesc: 'Baca, sisipkan, ganti, format, perubahan terlacak, dan komentar',
  aiCmdSkillFiles: 'Membaca lampiran',
  aiCmdSkillFilesDesc: 'Baca teks lampiran yang Anda unggah',
  aiCmdSkillWeb: 'Penelusuran web',
  aiCmdSkillWebDesc: 'Dukung jawaban dengan sumber terbaru',
  aiCmdSkillImage: 'Penelusuran gambar',
  aiCmdSkillImageDesc: 'Temukan gambar untuk disisipkan',
  aiCmdSkillDraw: 'Buat gambar',
  aiCmdSkillDrawDesc: 'Buat dan sisipkan ilustrasi dari deskripsi',
  aiCmdTplBrief: 'Templat tugas',
  aiCmdTplBriefDesc: 'Tujuan / masukan / tindakan / batasan / keluaran / kriteria penerimaan',
  aiCmdTplBriefInsert: 'Tujuan:\nMasukan:\nTindakan:\nBatasan:\nKeluaran:\nKriteria penerimaan:',
  aiActiveSkill: 'Keterampilan aktif',
  aiActiveSkillClear: 'Hapus keterampilan ini',
