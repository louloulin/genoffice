...
export const es = {
  ...
  aiInlineLauncherShorten: 'Acortar',
  aiInlineLauncherTranslate: 'Traducir',
  aiInlineLauncherSummarize: 'Resumir',
  aiTranslateDialogTitle: 'Traducir selección',
  aiTranslateTargetLang: 'Traducir a',
  aiTranslateSourceLang: 'Idioma origen detectado',
  aiTranslatePreserveFormat: 'Conservar el formato original (fuente/tamaño/alineación/tablas)',
  aiTranslateSwapLanguages: 'Intercambiar',
  aiTranslateStart: 'Traducir',
  aiTranslateOriginal: 'Original',
  aiTranslateTranslated: 'Traducido',
  aiTranslateUndo: 'Deshacer traducción',
  aiTranslateUndoFailed: 'No se pudo deshacer la traducción',
  aiTranslatePreviewTitle: 'Vista previa',
  aiTranslatePreviewLoading: 'Traduciendo…',
  aiTranslateUnsupported: 'Error de traducción (reintenta o revisa la clave API y el modelo en Ajustes → IA)',
  ...
  aiTranslateBtn: 'IA Traducir',
  aiTranslatePrompt: 'Traduce este contenido al idioma de la interfaz del usuario, conservando el formato original (fuente, tamaño, color, sangría, listas, encabezados, tablas, alineación, etc.). Si hay selección, traduce solo la selección; de lo contrario, traduce todo el documento.',
  ...
  aiCmdSkillDocsDesc: 'Leer, insertar, reemplazar, dar formato, cambios y comentarios',
  aiCmdSkillFiles: 'Lectura de adjuntos',
  aiCmdSkillFilesDesc: 'Leer el texto de los adjuntos que subiste',
  aiCmdSkillWeb: 'Búsqueda web',
  aiCmdSkillWebDesc: 'Respaldar la respuesta con fuentes actualizadas',
  aiCmdSkillImage: 'Búsqueda de imágenes',
  aiCmdSkillImageDesc: 'Encontrar imágenes para insertar',
  aiCmdSkillDraw: 'Generar imágenes',
  aiCmdSkillDrawDesc: 'Generar e insertar una ilustración a partir de una descripción',
  aiCmdTplBrief: 'Plantilla de tarea',
  aiCmdTplBriefDesc: 'Objetivo / entrada / acciones / restricciones / salida / criterios de aceptación',
  aiCmdTplBriefInsert: 'Objetivo:\nEntrada:\nAcciones:\nRestricciones:\nSalida:\nCriterios de aceptación:',
  aiActiveSkill: 'Habilidad activa',
  aiActiveSkillClear: 'Quitar esta habilidad',
