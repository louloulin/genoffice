...
export const fr = {
  ...
  aiInlineLauncherTitle: 'Assistant IA',
  aiInlineLauncherPolish: 'Peaufiner',
  aiInlineLauncherExpand: 'Développer',
  aiInlineLauncherShorten: 'Raccourcir',
  aiInlineLauncherTranslate: 'Traduire',
  aiInlineLauncherSummarize: 'Résumer',
  aiTranslateDialogTitle: 'Traduire la sélection',
  aiTranslateTargetLang: 'Traduire vers',
  aiTranslateSourceLang: 'Langue source détectée',
  aiTranslatePreserveFormat: 'Conserver la mise en forme (police/taille/alignement/tableaux)',
  aiTranslateSwapLanguages: 'Inverser',
  aiTranslateStart: 'Traduire',
  aiTranslateOriginal: 'Original',
  aiTranslateTranslated: 'Traduit',
  aiTranslateUndo: 'Annuler la traduction',
  aiTranslateUndoFailed: 'Impossible d\'annuler la traduction',
  aiTranslatePreviewTitle: 'Aperçu',
  aiTranslatePreviewLoading: 'Traduction…',
  aiTranslateUnsupported: 'Échec de la traduction (réessayez ou vérifiez la clé API et le modèle dans Paramètres → IA)',
  ...
  aiCmdSkillDocsDesc: 'Lire, insérer, remplacer, mettre en forme, révisions et commentaires',
  aiCmdSkillFiles: 'Lecture des pièces jointes',
  aiCmdSkillFilesDesc: 'Lire le texte des pièces jointes importées',
  aiCmdSkillWeb: 'Recherche web',
  aiCmdSkillWebDesc: 'Appuyer la réponse sur des sources à jour',
  aiCmdSkillImage: 'Recherche d\'images',
  aiCmdSkillImageDesc: 'Trouver des images à insérer',
  aiCmdSkillDraw: 'Générer des images',
  aiCmdSkillDrawDesc: 'Générer et insérer une illustration à partir d\'une description',
  aiCmdTplBrief: 'Modèle de consigne',
  aiCmdTplBriefDesc: 'Objectif / entrée / actions / contraintes / sortie / critères d\'acceptation',
  aiCmdTplBriefInsert: 'Objectif :\nEntrée :\nActions :\nContraintes :\nSortie :\nCritères d\'acceptation :',
  aiActiveSkill: 'Compétence active',
  aiActiveSkillClear: 'Retirer cette compétence',
