...
export const it = {
  ...
  aiInlineLauncherShorten: 'Accorcia',
  aiInlineLauncherTranslate: 'Traduci',
  aiInlineLauncherSummarize: 'Riassumi',
  aiTranslateDialogTitle: 'Traduci selezione',
  aiTranslateTargetLang: 'Traduci in',
  aiTranslateSourceLang: 'Lingua sorgente rilevata',
  aiTranslatePreserveFormat: 'Mantieni formattazione originale (font/dimensione/allineamento/tabelle)',
  aiTranslateSwapLanguages: 'Inverti',
  aiTranslateStart: 'Traduci',
  aiTranslateOriginal: 'Originale',
  aiTranslateTranslated: 'Tradotto',
  aiTranslateUndo: 'Annulla traduzione',
  aiTranslateUndoFailed: 'Impossibile annullare la traduzione',
  aiTranslatePreviewTitle: 'Anteprima',
  aiTranslatePreviewLoading: 'Traduzione in corso…',
  aiTranslateUnsupported: 'Traduzione non riuscita (riprova o controlla la chiave API e il modello in Impostazioni → IA)',
  ...
  aiCmdSkillDocsDesc: 'Leggi, inserisci, sostituisci, formatta, revisioni e commenti',
  aiCmdSkillFiles: 'Lettura allegati',
  aiCmdSkillFilesDesc: 'Leggi il testo degli allegati caricati',
  aiCmdSkillWeb: 'Ricerca web',
  aiCmdSkillWebDesc: 'Basa la risposta su fonti aggiornate',
  aiCmdSkillImage: 'Ricerca immagini',
  aiCmdSkillImageDesc: 'Trova immagini da inserire',
  aiCmdSkillDraw: 'Genera immagini',
  aiCmdSkillDrawDesc: 'Genera e inserisci un\'illustrazione da una descrizione',
  aiCmdTplBrief: 'Modello di attività',
  aiCmdTplBriefDesc: 'Obiettivo / input / azioni / vincoli / output / criteri di accettazione',
  aiCmdTplBriefInsert: 'Obiettivo:\nInput:\nAzioni:\nVincoli:\nOutput:\nCriteri di accettazione:',
  aiActiveSkill: 'Competenza attiva',
  aiActiveSkillClear: 'Rimuovi questa competenza',
