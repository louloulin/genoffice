...
export const ar = {
  ...
  aiInlineLauncherShorten: 'اختصار',
  aiInlineLauncherTranslate: 'ترجمة',
  aiInlineLauncherSummarize: 'تلخيص',
  aiTranslateDialogTitle: 'ترجمة المحدد',
  aiTranslateTargetLang: 'الترجمة إلى',
  aiTranslateSourceLang: 'اللغة المصدر المكتشفة',
  aiTranslatePreserveFormat: 'الاحتفاظ بالتنسيق الأصلي (الخط/الحجم/المحاذاة/الجداول)',
  aiTranslateSwapLanguages: 'تبديل',
  aiTranslateStart: 'ترجمة',
  aiTranslateOriginal: 'الأصلي',
  aiTranslateTranslated: 'المترجم',
  aiTranslateUndo: 'التراجع عن الترجمة',
  aiTranslateUndoFailed: 'تعذر التراجع عن الترجمة',
  aiTranslatePreviewTitle: 'معاينة',
  aiTranslatePreviewLoading: 'جارٍ الترجمة…',
  aiTranslateUnsupported: 'فشل الترجمة (أعد المحاولة أو تحقّق من مفتاح API والنموذج في الإعدادات ← الذكاء الاصطناعي)',
  ...
  aiTranslateBtn: 'ذكاء ترجمة',
  aiTranslatePrompt: 'ترجم هذا المحتوى إلى لغة واجهة المستخدم، مع الحفاظ على التنسيق الأصلي (الخط، الحجم، اللون، المسافة البادئة، القوائم، العناوين، الجداول، المحاذاة). إذا كان هناك تحديد، ترجم التحديد فقط؛ وإلا ترجم المستند بأكمله.',
  ...
  aiCmdSkillDocsDesc: 'قراءة وإدراج واستبدال وتنسيق وتتبّع التغييرات والتعليقات',
  aiCmdSkillFiles: 'قراءة المرفقات',
  aiCmdSkillFilesDesc: 'قراءة نص المرفقات التي رفعتها',
  aiCmdSkillWeb: 'البحث في الويب',
  aiCmdSkillWebDesc: 'دعم الإجابة بمصادر حديثة',
  aiCmdSkillImage: 'البحث عن الصور',
  aiCmdSkillImageDesc: 'إيجاد صور لإدراجها',
  aiCmdSkillDraw: 'توليد الصور',
  aiCmdSkillDrawDesc: 'توليد رسم توضيحي وإدراجه من وصف',
  aiCmdTplBrief: 'قالب المهمة',
  aiCmdTplBriefDesc: 'الهدف / المدخلات / الإجراءات / القيود / المخرجات / معايير القبول',
  aiCmdTplBriefInsert: 'الهدف:\nالمدخلات:\nالإجراءات:\nالقيود:\nالمخرجات:\nمعايير القبول:',
  aiActiveSkill: 'مهارة مفعّلة',
  aiActiveSkillClear: 'إزالة هذه المهارة',
