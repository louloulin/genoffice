...
export const pl = {
  ...
  aiCmdSkillDocsDesc: 'Czytaj, wstawiaj, zastępuj, formatuj, zmiany i komentarze',
  aiCmdSkillFiles: 'Czytanie załączników',
  aiCmdSkillFilesDesc: 'Czytaj treść przesłanych załączników',
  aiCmdSkillWeb: 'Wyszukiwanie w sieci',
  aiCmdSkillWebDesc: 'Oprzyj odpowiedź na aktualnych źródłach',
  aiCmdSkillImage: 'Wyszukiwanie obrazów',
  aiCmdSkillImageDesc: 'Znajdź obrazy do wstawienia',
  aiCmdSkillDraw: 'Generowanie obrazów',
  aiCmdSkillDrawDesc: 'Wygeneruj i wstaw ilustrację z opisu',
  aiCmdTplBrief: 'Szablon zadania',
  aiCmdTplBriefDesc: 'Cel / dane wejściowe / działania / ograniczenia / wynik / kryteria odbioru',
  aiCmdTplBriefInsert: 'Cel:\nDane wejściowe:\nDziałania:\nOgraniczenia:\nWynik:\nKryteria odbioru:',
  aiActiveSkill: 'Aktywna umiejętność',
  aiActiveSkillClear: 'Usuń tę umiejętność',
