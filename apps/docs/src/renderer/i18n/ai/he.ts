...
export const he = {
  ...
  aiCmdSkillDocsDesc: 'קריאה, הוספה, החלפה, עיצוב, מעקב שינויים והערות',
  aiCmdSkillFiles: 'קריאת קבצים מצורפים',
  aiCmdSkillFilesDesc: 'קריאת הטקסט של הקבצים שהעלית',
  aiCmdSkillWeb: 'חיפוש באינטרנט',
  aiCmdSkillWebDesc: 'ביסוס התשובה על מקורות עדכניים',
  aiCmdSkillImage: 'חיפוש תמונות',
  aiCmdSkillImageDesc: 'איתור תמונות להוספה',
  aiCmdSkillDraw: 'יצירת תמונות',
  aiCmdSkillDrawDesc: 'יצירה והוספה של איור מתוך תיאור',
  aiCmdTplBrief: 'תבנית משימה',
  aiCmdTplBriefDesc: 'מטרה / קלט / פעולות / אילוצים / פלט / קריטריוני קבלה',
  aiCmdTplBriefInsert: 'מטרה:\nקלט:\nפעולות:\nאילוצים:\nפלט:\nקריטריוני קבלה:',
  aiActiveSkill: 'מיומנות פעילה',
  aiActiveSkillClear: 'הסרת מיומנות זו',
